 ...
 * challenge, you're going to practice throwing and propagating an exception. Check out the Tutorial tab for learning
 ...
 * number of test cases. Each of the T subsequent lines describes a test case in 2 space-separated integers denoting n
 * and p, respectively.
 *
 * Constraints
 ...
 * line contains the result of n^p as calculated by your Calculator class' power method.
 *
 * Sample Input
 * 4
 * 3 5
 ...
 * T2: Both inputs (-1 and -2) are negative, so power throws an exception and "n and p should be non-negative" is
 * printed.
